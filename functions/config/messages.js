const messages = {
    'de': {
        translation: {
            ...
            'FAQ_BORDER': '<speak>Zur Eindämmung der Verbreitung des Corona-Virus wurden durch das Bundesministerium für Inneres Grenzkontrollen eingeführt. Eine Einreise nach Österreich ist ausnahmslos nur noch an bestimmten Grenzübergängen erlaubt. Personen, die nach Österreich einreisen wollen, haben ein ärztliches Zeugnis über ihren Gesundheitszustand mit sich zu führen. Weitere Informationen zur Einreise findet sich unter <say-as interpret-as="verbatim">bmi.gv.at</say-as>.</speak>',
            'FAQ_MASKS': 'Die wichtigsten und effektivsten Maßnahmen zum persönlichen Schutz sowie zum Schutz von anderen Personen vor der Ansteckung sind eine gute Händehygiene, korrekte Hustenetikette und das Einhalten des Mindestabstandes von ca. 1 bis 2 Metern. Zum jetzigen Zeitpunkt wird das Tragen von Hygiene- bzw. Atemschutzmasken für die gesunde Allgemeinbevölkerung nicht empfohlen.',
