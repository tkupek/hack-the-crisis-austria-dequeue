const messages = {
    'de': {
        translation: {
            ...
            'DANGER_ZONE': 'Zu den Risikogebieten in Österreich zählen aktuell: Tirol, in Vorarlberg die Gemeinden Lech, Zürs, Stuben, Warth und Schröcken und in Kärnten die Gemeinde Heiligenblut.',
            'PREGNANT': 'Derzeit ergeben sich keine Hinweise, dass Schwangere durch eine Covid-19-Erkrankung mehr gefährdet sind als andere Personen: Bisherige Erfahrungen zeigen, dass Schwangere im Falle einer Erkrankung nur leichte bis mittelschwere Symptome aufweisen.',
            'TEST_ANIMALS': 'Derzeit gibt es keine speziellen Tests für Tiere, da nach aktuellen Kentnissen Haustiere nicht erkranken bzw. Menschen infizieren können.',
            'INFECTED_ANIMALS': 'Es gibt aktuell keine Hinweise, dass Haustiere erkranken können bzw. Menschen infizieren.',
            ...
            'TEST_2': 'Haben Sie mindestens ein relevantes Krankheitssymptom (Kurzatmigkeit oder, trockener Husten kombiniert mit Fieber über 38°C), welches plötzlich und ohne plausible Erklärung aufgetreten ist?',
